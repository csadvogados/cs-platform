...
from app.models.financial import Income, Expense, Creditor, Debt, Diagnosis, PaymentAgreement, PaymentInstallment
...
__all__ = [
    ...
    "Income", "Expense", "Creditor", "Debt", "Diagnosis", "PaymentAgreement", "PaymentInstallment",
