...
from app.models.crm import CRMContact, CRMInteraction, CRMOpportunity, CRMOpportunityStageHistory, CRMTask
...
__all__ = [
    ...
    "role_permissions", "user_roles",
    "CRMContact", "CRMInteraction", "CRMOpportunity", "CRMOpportunityStageHistory", "CRMTask", "Case",
]
